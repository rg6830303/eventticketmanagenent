...
export function LegalCallout({
  ...
  return (
    <div className={cn('card mt-6 border-l-[5px] border-l-vybe-500 bg-vybe-50 p-5 sm:p-6', className)}>
  ...
  return (
    <div className="relative overflow-hidden">
      ...
      <div className="shell relative pb-24 pt-16 sm:pt-24 lg:pb-32">
        ...
        <div
          role="note"
          className="card mt-10 flex items-start gap-4 border-l-[5px] border-l-vybe-500 bg-vybe-50 p-5 sm:p-6"
        >
          <ShieldIcon />
          <div>
        ...
        <div className="mt-14 grid gap-12 lg:mt-16 lg:grid-cols-[236px_minmax(0,1fr)] lg:gap-16">
          ...
          <div>
            <details className="card mb-10 px-5 py-4 lg:hidden">
