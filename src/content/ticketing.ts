...
export const FALLBACK_TICKET_TIERS = [
  {
    ...
    name: 'General Access',
    description:
      'Solo entry to the complete non-alcoholic party.',
    pricePaise: 111_100,
    redeemablePaise: 0,
    pax: 1,
    priceUnit: '/ pass',
    remaining: 100_000,
    total: 100_000,
    perks: ['Admits 1 guest', 'Full party access'],
  },
  {
    code: 'GROUP',
    name: 'Group of 5',
    description: 'Entry for five.',
    pricePaise: 444_400,
    redeemablePaise: 0,
    pax: 5,
    priceUnit: '/ group',
    remaining: 100_000,
    total: 100_000,
    perks: ['Admits 5 guests', 'Best value for a group'],
  },
  {
    code: 'EARLY',
    name: 'Group of 10',
    description: 'Entry for ten.',
    pricePaise: 888_800,
    redeemablePaise: 0,
    pax: 10,
    priceUnit: '/ group',
    remaining: 100_000,
    total: 100_000,
    perks: ['Admits 10 guests', 'Full party access'],
  },
] as const;
