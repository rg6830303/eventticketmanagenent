    ...
    <div className="relative flex min-h-dvh items-center justify-center overflow-hidden px-4 py-16">
      <div aria-hidden className="pointer-events-none absolute inset-0">
        ...
        <div className="absolute left-1/2 top-1/2 h-[min(150vw,760px)] w-[min(150vw,760px)] -translate-x-1/2 -translate-y-1/2">
          <Globe spin strokeWidth={0.8} className="h-full w-full text-flare/[0.10]" />
        </div>
      </div>
      ...
      <div className="relative w-full max-w-[400px]">
        <div className="mb-8 flex flex-col items-center text-center">
          ...
          <h1 className="mt-5 font-display text-2xl font-bold text-chalk">Staff sign in</h1>
  ...
  return (
    <div className="space-y-4" aria-hidden>
      <div className="space-y-2">
        <div className="h-3 w-24 rounded bg-elevated/70" />
        <div className="h-[52px] w-full animate-pulse rounded-xl bg-elevated/50" />
      </div>
      <div className="space-y-2">
        <div className="h-3 w-20 rounded bg-elevated/70" />
        <div className="h-[52px] w-full animate-pulse rounded-xl bg-elevated/50" />
      </div>
      <div className="min-h-[24px]" />
      <div className="h-[52px] w-full animate-pulse rounded-full bg-elevated/50" />
    </div>
  );
}
